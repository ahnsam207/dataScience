...
with col:
    st.markdown(
        ...
        '<div style="font-size:18px; line-height:2.2; color:white;">'
        ...
        '<span style="font-size:18px; color:#ffeb3b; font-weight:700;">교수님께 먼저 감사를 전합니다.</span>'
        '</div>'
        '</div>'

        '<div style="background:rgba(255,255,255,0.07); border-radius:16px; padding:32px 36px;">'
        '<div style="font-size:16px; color:rgba(255,255,255,0.6); font-weight:700; margin-bottom:20px; letter-spacing:1px;">💡 이번 실습을 통해 느낀 것</div>'
        ...
        '<div style="font-size:17px; line-height:2.0; color:white;">'
        ...
        '<br>놓치고 있던 내용과 의문을 가졌던 내용이 해소되고 정리되는 기회가 된 것 같습니다.'
        '</div>'
        '</div>'
        ...
        '<span style="font-size:20px; color:#ffeb3b; font-weight:800;">감사합니다 🙏</span>'
        '</div>'
