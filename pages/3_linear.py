...
# ══════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        '<span style="font-size:20px; font-weight:800; color:#1565c0;">종속변수 DQ3(학업성적)의 응답 척도 확인</span>'
        '</div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        ...
        '<div style="font-size:18px; font-weight:800; color:#ff8a80; margin-bottom:10px;">📖 등간성이란?</div>'
        '<div style="font-size:16px; line-height:1.9; color:#cfd8dc;">'
        '등간성(等間性, Equal Interval)이란 <span style="color:#69f0ae; font-weight:700;">척도의 각 단계 간 간격이 동일하다는 가정</span>입니다.<br>'
        ...
        ' <span style="color:#69f0ae; font-weight:700;">해당 변수를 연속형으로 처리할 수 있습니다.</span><br>'
        '<span style="color:#ff8a80; font-weight:700;">학업 성적(DQ3)처럼 순서 간격이 균등하다고 가정 가능한 경우 다중 선형 회귀분석 적용이 허용됩니다.</span>'
        '</div>'
        '</div>'

        '<div style="background:rgba(255,255,255,0.07); border-radius:12px; padding:20px 24px;">'
        '<div style="font-size:18px; font-weight:800; color:#ff8a80; margin-bottom:10px;">📖 중심극한정리란?</div>'
        '<div style="font-size:16px; line-height:1.9; color:#cfd8dc;">'
        ...
        ' <span style="color:#ff8a80; font-weight:700;">표본 평균의 분포가 정규분포에 가까워진다</span>'
        '는 통계학의 핵심 정리입니다.<br>'
    ...
    if os.path.exists(img_path4):
        ...
        st.markdown(
            ...
            ' <span style="color:#888;">(사용 목적이 학교 숙제)</span>'
            ' 와 '
            '<span style="background:#fff3e0; border-radius:8px; padding:2px 10px;'
            ' font-weight:700; color:#e65100;">use_grade</span>'
            ' <span style="color:#888;">(사용 목적이 학교 성적 향상)</span>'
            ' 변수 간 상관계수가'
            ' <span style="font-weight:900; color:#e53935;">0.83</span> 으로'
            '</div>'
            '<div style="font-size:17px; line-height:2.0; color:#222; padding-left:10px;">'
            '<span style="font-weight:700; color:#e53935;">강한 양의 상관관계</span>'
            ' 가 있음을 확인할 수 있음.'
            '</div>'
            '</div>',
            unsafe_allow_html=True
