...
# ══════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        '<span style="color:#26a69a; font-size:20px; flex-shrink:0; margin-top:2px;">▪</span>'
    ...
    st.markdown(
        ...
        '<div style="font-size:17px; line-height:1.9; color:#222;">'
        '분석 결과를 <b>Streamlit URL</b> 형태로 공유 및 발표 <span style="color:#8e24aa; font-weight:600;">(PPT 없이 발표하는 것을 권장)</span>'
        '</div>'
        '</div>'
    ...
    st.markdown(
        ...
        ' padding:6px 18px; font-size:16px; font-weight:700; min-width:40px; text-align:center;">01</span>'
        ...
        ' padding:6px 18px; font-size:16px; font-weight:700; min-width:40px; text-align:center;">02</span>'
        '<span style="font-size:17px; color:#222; font-weight:500;">🔍 연구주제</span>'
        '</div>'

        '<div style="display:flex; align-items:center; gap:14px;">'
        '<span style="background:#f4511e; color:white; border-radius:10px;'
        ' padding:6px 18px; font-size:16px; font-weight:700; min-width:40px; text-align:center;">03</span>'
        ...
        ' padding:6px 18px; font-size:16px; font-weight:700; min-width:40px; text-align:center;">04</span>'
        ...
        ' padding:6px 18px; font-size:16px; font-weight:700; min-width:40px; text-align:center;">05</span>'
